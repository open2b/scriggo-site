...
<dl>
    ...
    <dd><a href="#there-is-still-room-for-optimization">Is there still room for optimization?</a></dd>
...
released. This is a known limitation of the Go reflect implementation. Specifying the same type does not result,
...
Scriggo v0.61.1 is currently used in production. It is not yet in version 1.0 as
there are some parts of the Go specification to implement, and we still want to
be free to make small and limited changes to the template specification and
packages after receiving feedback from the community.
...
integrated programming language. Moreover, it has a non-immediately understandable syntax for those coming from other
