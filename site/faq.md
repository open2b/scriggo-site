...
<dl>
    ...
    <dd><a href="#can-it-be-used-in-production">Can it be used in production?</a></dd>
...
templating engines like Jinja and Liquid.
...
[template specification](/template-spec#truthful-values).
...
function defined in the source code and one for each native function called by the Scriggo functions. Templates have an
